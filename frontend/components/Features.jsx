        ...
        <section className="w-full bg-[#f8fafc] py-24">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-veri5-navy mb-4">Simple. Secure. Respectful.</h2>
                    <p className="text-gray-500 text-lg">We've redesigned the verification process to prioritize your dignity.</p>
                </div>

                <div className="grid md:grid-cols-3 gap-8">
                    {features.map((feature, idx) => (
                        <div key={idx} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100/50 hover:shadow-md transition-all duration-300">
                            ...
                            <h3 className="text-xl font-bold text-veri5-navy mb-3">{feature.title}</h3>
